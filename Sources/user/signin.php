...
<div id="id01" class="modal">
  ...
  <div class="modal-content animate">
    <div class="imgcontainer">
      ...
      <img src="/webshop/img/img_avatar2.png" alt="Avatar" class="avatar">
      <p id="error" style='color: red; text-align: center;'></p><p id="ok" style='color: green; text-align: center;'></p>
    </div>
    ...
    <div class="container">
      ...
      <button type="button" id="submit">Đăng nhập</button>
    </div>
...
<script type="text/javascript">
    $("#submit").on("click", function(){
        ...
        // Kiểm tra nếu email và mật khẩu rỗng thì báo lỗi
        if (email == "" || psw == "") {
